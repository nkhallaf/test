...
//                    {
//                        if (words[0].lemma == "شَهْرِيّ_1" || words[0].lemma =="صَحِيفَة_1" || words[0].lemma =="نَشْرَة_1" || words[0].lemma =="جُورْنال_1")
//                        {
//                            #region noun Before
...
//                            if (percWords[3].pos == "noun_prop" || percWords[0].lemma == "دُكْتُور_1"
...
//                    {
//                        if (percWords[0].pos == "digit" || percWords[0].pos == "noun_num" || percWords[0].pos == "adj_num")
//                        {
...
//                    {
//                        if (words[0].lemma == "هَرَم_2" || words[0].lemma == "مَقْبَر_1"
...
//                    {
//                        if (words[0].lemma == "مِيناء_1" || words[0].lemma == "مَرْفَأ_1")
//                        {
//                            if (words.Count> 1&&( words[1].pos == "noun")
//                            {
//                                if (words.Count> 2&&( words[2].pos == "noun_prop")
...
//                    {
//                        if (words[0].lemma == "جامِع_1" || words[0].lemma == "مَسْجِد_1" || words[0].lemma == "كَنِيسَة_1" || words[0].lemma == "كاتِدرائِيَّة_1")
//                        {
//                            if (words.Count >= 2)
//                            {
//                                if (words.Count> 1&&( words[1].pos == "noun_prop")
...
//                    {
//                        if (words[0].lemma == "مَسْرَح_1" || words[0].lemma == "سِينَما_1" || words[0].lemma == "أُوبِرا_1")
//                        {
//                            if (words.Count> 1&&( words[1].pos == "noun_prop")
//                            {
//                                if (words.Count> 2&&( words[2].pos == "noun_prop" || words[2].pos == "noun")
...
//                    {
//                        if (words[0].lemma == "مَتْحَف_1" || words[0].lemma == "مَعْبَد_1")
//                        {
//                            if (words.Count> 1&&( words[1].pos == "noun_prop")
//                            {
//                                if (words.Count> 2&&( words[2].pos == "noun_prop" || words[2].pos == "adj")
...
//                    {
//                        if (words[0].lemma=="مَلْعَب_1" || words[0].lemma=="إِسْتاد_1"
...
//                    {
//                        if (words[0].lemma == "مُتَنَزَّه_1" || words[0].lemma == "حَدِيقَة_1" || words[0].lemma == "مَحْمِيّ_1")
//                        {
//                            if (words.Count> 1&&( words[1].pos == "noun_prop")
//                            {
...
//                    {
//                        if (words[0].lemma == "بَلَدِيَّة_1" || words[0].lemma == "مَبْنَى_1"
...
//                    {
//                        if (words[0].lemma == "مَدْرَسَة_1" || words[0].lemma == "جامِعَة_1"
...
//                    {
//                        if (words[0].lemma == "جِسْر_1" || words[0].lemma == "كُوبْرِي_1")
//                        {
//                            if (words.Count> 1&&( words[1].pos == "noun_prop")
//                            {
//                                if (words.Count> 2&&( words[2].pos == "" || words[2].pos == "noun_prop" || words[2].pos == "abbrev")
...
//                    {
//                        if (words[0].lemma == "مُدِين_1" || words[0].lemma == "مَدِينَة_1")
//                        {
//                            if (words.Count> 1&&( words[1].pos == "noun_prop" || words[1].pos == "")
//                            {
//                                diacLineWords[loc] = "<font title='Trigger word-" + triggerWords[wordTagIndex].Tag.ToUpper() + "' style='color:" + triggerWords[wordTagIndex].Color + "'>" + diacLineWords[loc];
...
//                    {
//                        if (words[0].lemma == "جَزِيرَة_1" || words[1].lemma == "جَزِيرَة_1")
//                        {
//                            if (words.Count> 1&&( words[1].pos == "noun_prop" || words[1].pos == "")
//                            {
//                                diacLineWords[loc] = "<font title='Trigger word-" + triggerWords[wordTagIndex].Tag.ToUpper() + "' style='color:" + triggerWords[wordTagIndex].Color + "'>" + diacLineWords[loc];
...
//                    {
//                        if (words[0].lemma == "بَحْر_1" || words[0].lemma == "حَرّ_1")
//                        {
//                            if (words.Count> 1&&( words[1].pos == "noun_prop" || words[1].pos == "" || words[1].pos == "noun")
//                            {
//                                diacLineWords[loc] = "<font title='Trigger word-" + triggerWords[wordTagIndex].Tag.ToUpper() + "' style='color:" + triggerWords[wordTagIndex].Color + "'>" + diacLineWords[loc];
...
//                    {
//                        if (words[0].lemma == "عالَمِيّ_1" || words[0].lemma == "دُوَلِيّ_1" || words[1].lemma == "عالَمِيّ_1" || words[1].lemma == "دُوَلِيّ_1" || words[2].lemma == "عالَمِيّ_1" || words[2].lemma == "دُوَلِيّ_1" || words[3].lemma == "عالَمِيّ_1" || words[3].lemma == "دُوَلِيّ_1" || words[4].lemma == "عالَمِيّ_1" || words[4].lemma == "دُوَلِيّ_1")
//                        {
//                            if (words.Count> 1&&( words[1].pos == "noun")
//                            {
...
//                    {
//                        if (words[0].lemma == "كَرّ_1" || words[0].lemma == "رِياضِيّ_1" || words[1].lemma == "كَرّ_1" || words[1].lemma == "رِياضِيّ_1" || words[2].lemma == "كَرّ_1" || words[2].lemma == "رِياضِيّ_1" || words[3].lemma == "كَرّ_1" || words[3].lemma == "رِياضِيّ_1" || words[4].lemma == "كَرّ_1" || words[4].lemma == "رِياضِيّ_1")
//                        {
//                            if (words.Count> 1&&( words[1].pos == "noun")
//                            {
//                                if (words.Count> 2&&( words[2].pos == "adj" && words[3].pos == "adj" && words[2].prc0 == "Al_det" && words[3].prc0 == "Al_det")
...
//                    {
//                        if (words[0].lemma == "حُكُومَة_1" || words[0].lemma == "وِزارَة_1")
//                        {
//                            if (words.Count> 1&&( words[1].pos == "noun")
//                            {
//                                if (words.Count> 2&&( words[2].pos == "noun")
...
//                    {
//                        if (words[0].lemma == "حَرْبِيّ_1" || words[0].lemma == "تَحْرِير_1"
